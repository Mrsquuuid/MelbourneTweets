	...
	export default {
		...
		methods: {
			...
			initChart() {
				...
				var option = {
					title: {
						text: 'The average sentiment scores for tweets containing keywords related to China from 2019 to 2020',
						x: 'center',
						y: 'top'
					},
					tooltip: {},
					...
					series: [{
							name: 'Covid Word',
							type: 'line',
							data: this.data.china_covid_stats.avg,
							color: '#5470c6'
						},
						{
							name: 'China Word',
							type: 'line',
							data: this.data.china_stats.avg,
							color: '#20ffff'
						},
						{
							name: 'Vulgar Word',
							type: 'line',
							data: this.data.china_vulgar_stats.avg,
							color: '#fc0107'
						}
					]
				};
